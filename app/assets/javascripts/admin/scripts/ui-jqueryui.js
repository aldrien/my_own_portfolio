var UIJQueryUI = function () {
    ...
    var handleDatePickers = function () {
	    ...
	    $( ".date_picker_range_from" ).datepicker({
	      defaultDate: "+1w",
	      changeMonth: true,
	      numberOfMonths: 2,
	      onClose: function( selectedDate ) {
	        // $( ".date_picker_range_to" ).datepicker( "option", "minDate", selectedDate );
	      }
	    });
	    $( ".date_picker_range_to" ).datepicker({
	      defaultDate: "+1w",
	      changeMonth: true,
	      numberOfMonths: 2,
	      onClose: function( selectedDate ) {
	        // $( ".date_picker_range_from" ).datepicker( "option", "maxDate", selectedDate );
	      }
	    });
