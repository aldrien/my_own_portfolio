class Portfolio < ActiveRecord::Base
  ...
  validates_presence_of :title, :portfolio_type
  ...
  :url  => "/images/portfolios/:id/:style/:basename.:extension",
  :path => ":rails_root/public/images/portfolios/:id/:style/:basename.:extension",
